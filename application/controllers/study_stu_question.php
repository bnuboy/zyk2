...
class Study_Stu_Question extends StudyController {
    ...
    function index($start = 0) {
        ...
        //构造分页
        $config['base_url'] = base_url() . 'study_stu_question/index';
    ...
    function reply($id) {
        ...
        if ($post['reply']) {
            ...
            Util::redirect('/study_stu_question/index');
        } else {
    ...
    function delete_one($id) {
        $this->Study_Question_Model->delete(array($id));
        Util::redirect('/study_stu_question/index');
    }
    ...
    function question_list($start = 0) {
        ...
        //构造分页
        $config['base_url'] = base_url() . 'study_stu_question/question_list';
        $config['total_rows'] = $count;
        $config['per_page'] = $limit;
        $this->adminpagination->initialize($config);
        $pagination = $this->adminpagination->create_links();
    ...
    function faq_question($start = 0) {
        ...
        $count = $this->Study_Question_Model->getQuestionCount($where);
        //构造分页
        $config['base_url'] = base_url() . 'study_stu_question/faq_question';
        $config['total_rows'] = $count;
        $config['per_page'] = $limit;
        $this->adminpagination->initialize($config);
        $pagination = $this->adminpagination->create_links();
    ...
    function faq_addup() {
        ...
        if (!empty($post)) {
            ...
            Util::redirect('/study_stu_question/faq_question');
        }
    }
    ...
    function collect($start = 0) {
        ...
        $config['base_url'] = base_url() . 'study_stu_question/collect';
        $config['total_rows'] = $count;
        $config['per_page'] = $limit;
        $this->adminpagination->initialize($config);
        $pagination = $this->adminpagination->create_links();
    ...
    function my_question($start=0)
    {
        ...
        $config['base_url'] = base_url().'study_stu_question/my_question';
        $config['total_rows'] =$count;
        $config['per_page'] = $limit;
        $this->adminpagination->initialize($config);
        $pagination = $this->adminpagination->create_links();
