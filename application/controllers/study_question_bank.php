...
;        $limit=10;
    ...
    { 
        ...
        $zsd = $this->Study_Coursecontent_Model->getTreeCourses("`course_id` = ".$this->course['id'],"*","order DESC");//print_r($zsd);
    ...
    function edit_danxuan($patterntype_id,$id)
    {
        ...
        $zsd = $this->Study_Coursecontent_Model->getTreeCourses("`course_id` = ".$this->course['id'],"*","order DESC");
        $result = Array(
            'info'          => $info,
            'pattern'       => $pattern,
    ...
    function delete($id)
    {
        ...
        try{
            $attr = $this->input->post('item_id');
            $this->Study_Question_Bank_Model->timu_delete($type[$id],$attr);
            $this->AJAXSuccess();
        }  catch (Exception $ex)
        {
            $this->AJAXFail();
