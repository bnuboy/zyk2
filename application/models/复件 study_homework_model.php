...
class Study_HomeWork_Model extends DAO
{
    ...
    {
        $this->db->select($dbname.'.zsd_id,gz_study_pattern.name as tixing_name,gz_study_pattern.id as tixing_id,gz_study_plan.title as zsd_name');
        $this->db->join('gz_study_plan','gz_study_plan.id = '.$dbname.'.zsd_id');
