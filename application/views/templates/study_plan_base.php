            ...
            <div class="centerboxbg">
                <div class="centerboxbtm">
                    ...
                    <div class="centerleft">
                        ...
                        <div class="menubox">
                            <ul>
							    <li <?php if($this->uri->segment( 2 ) == 'addfolder' || $this->uri->segment( 2 ) == 'index') echo "class='overadd'"; ?> >
                                    <a title="新建文件夹" href="/study_plan/addfolder">新建文件夹
                                    </a>
                                </li>
                                <?php foreach ( $menus as $menu )
                                {
                                  ?>
                                    <li <?php if ( isset( $id ) )
                                    {
                                     echo    $id==$menu[ 'id' ] ?"class='over'":"";
                                    } ?>><a  href="/study_plan/index/<?=$menu['id']?>"><?= $menu[ 'title' ] ?></a></li>
                           <?php } ?>
