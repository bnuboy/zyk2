  ...
  <head>
    ...
    <?php
	  ...
	  foreach($organizations as $key => $value){
          ...
          $str.= '{name:"'.$value['name'].'", pId:'.$value['id'].',url:"/ucenter_select_course/index/'.$value['id'].'", target:"_self" , isHover: true}';
          if(($key+1) < count($organizations)) $str .= ",";
     }
     ?>
		var zNodes =[<?=$str?>];
    ...
    <div class="centerboxbg" style="margin-bottom:0;">
        ...
        <div class="resourbox">
            <div class="writeaddtit">
                <div class="resourdatalink">大赛列表
                   <?php
                   foreach($catnav as $k => $v){
                       echo " > <a href='/ucenter_select_course/index/'".$v['id'].">".$v['name']."</a>";
                   }
               ?>
                </div>
                <div class="resourdataback"></div>
            </div>
