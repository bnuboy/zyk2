...
<script type="text/javascript">
  ...
  xmSlider.init({gallery:'slides',control:"pagination",dir:false,index:0,speed:20,interval:3000,type:'click'});
  });
</script>
<style>
.pagination {
...
<div class="content">
  <div class="Cleft">
    ...
    <div class="banner" id="slides">
      <ul class="slides_container">
        ...
        <li><a href="<?=!empty($v['url']) ? $v['url'] : '#this' ;?>" target="_blank"><img src="<?=$v['img'];?>" width="673" height="297" /></a></li>        
        <?php } ?>
      </ul>
    ...
    <div class="kczs mt10">
      <div class="news-top">
        <h3>课程展示</h3>
        <a href="/cms/courselist">全部课程</a></div>
      <div class="news-list">
  ...
  <div class="Cright">
    ...
    <!--用户登录 begin-->
    <div class="login rboder" id="logininbox">
