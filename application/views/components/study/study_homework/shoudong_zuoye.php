...
<?php $str = ""; foreach ( $list as $key => $value )
        {
        $checked = !empty( $roleNodeIds ) && in_array( $value[ 'id' ], $roleNodeIds ) ? ', checked:true' : '';
        $str .= '{ id:' . $value[ 'id' ] . ', pId:' . $value[ 'cid' ] . ', name:"' . $value[ 'title' ] . '", open:true ' . $checked . '}';
        if(($key+1) < count($list)) $str .= ",";
        }
?>		
		var zNodes =[<?=$str;?>
		 ];
...
<!--管理信息-->
<div class="noticesbox kecheng" id="frame1">
    <div class="noticewarp">
        ...
        <div class="noticenwarp">
            <form action="/study_homework/get_zhangjie_type" method="post" >
                ...
                <div class="noticekatebox">
                    ...
                    <div class="scselect" id="select_id">
                        ...
                        <input id="citySel" type="text" readonly value="" style="width:520px; height:28px;" onclick="showMenu();" />
		&nbsp;<a id="menuBtn" href="#" onclick="showMenu(); return false;">select</a>                      
                ...
                <div class="noticekatebox">
                    ...
                    <div class="addptime"><input name="start_time" type="text" maxlength="15px" id="start_time" value=""/></div>
                    <div class="addptimeshow"><a href="#"><strong>选择</strong></a></div>
                    <div class="addpnotwn">到　</div>
                    <div class="addptime"><input name="end_time" type="text" maxlength="15px" id="end_time" value=""/></div>
                    <div class="addptimeshow"><a href="#"><strong>选择</strong></a></div>
                </div>					
                ...
                <div class="noticekatebox" id="sendbut" style="margin-top:10px;">
                    ...
                    <div class="addbutin">
                        <input type="submit" class="addbut" value="下一步"  onClick="return hite1();"/></div>
                </div>
