    ...
    <body>
        <div class="Stc w400" style="width: 500px; border: 1px solid #C3D0E1; background: none repeat scroll 0 0 #F2F4F7;">
            ...
            <div class="Stc-bottom zcjg">
                <form action="/study_teach_manage/insert_user" method="post" onSubmit="return check();">
                    <table width="100%">
                        <tr>
                            <td width="15%" align="right">选择角色：</td>
                            <td>
                                <label>
                                    <select name="course_part_id" class="p5" id="course_part_id">
...
<?php } ?>
                        ...
                        <tr>
                            ...
                            <td width="25">
                                <label>
                                    <textarea style="width:360px;" name="users" id="textarea" cols="35" rows="5"></textarea>
                                </label>
                    ...
                    <p align="right" style="padding-right:50px;"><input type="submit" class="save" value="添加" /> <input type="reset" class="remove"  value="取消" onclick="return win_close();"/>
