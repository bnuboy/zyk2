...
<div class="noticewarp">
    ...
    <div class="noticenwarp">
        <form action="/study_coursenotice/edit/<?=$notice['id']?>" method="post" id="sub_form">
            <div class="noticekatebox">
                <div class="addpword">公告标题：</div>
                <div class="addptit"><input name="title" type="text" value="<?= $notice[ "title" ] ?>"/></div>
            ...
            <div class="noticekatebox">
                ...
                <div class="scselect">
                    <select name="priority"  class="p5">
                        ...
                        {
                        ?>
                            <option value="<?= $key ?>" <?= $notice[ "priority" ] == $key ? "selected=''" : "" ?>><?= $value ?></option>
                        <?php } ?>
                    </select>
                </div>
            </div>
            ...
            <div class="noticekatebox" style="height:184px;">
                ...
                <div class="addpease Elaber"><textarea name="content"><?=$notice['content']?></textarea></div>
