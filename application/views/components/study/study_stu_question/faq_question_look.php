...
<div class="noticesbox">
    <div class="noticewarp">
        <div class="noticetit tearch-nav tearch-navts">
            <h1>常见问题 -> 回复</h1>
            <div><a href="/study_stu_question/faq_question/">返回</a></div>
        </div>

        <div class="noticenwarp">
            <form action="/study_stu_question/reply/<?=$info['id']?>" method="post">
            ...
            <div class="noticekatebox" id="sendbut" style="margin-top:10px;">
                ...
                <div class="addbutdel addbutdel2"><input type="reset"  class="addbut" value="返回" onclick="location.href='/study_stu_question/faq_question'"/></div>
            </div>
            </form>
        </div>
