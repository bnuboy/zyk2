...
<script>
    function collect()
    {
        ...
        $.post("/study_stu_question/collect_status/", post_str , function(ret){
            if ( ret.status == "ok" ) {
                alert("取消成功");
                location.reload();
            } else {
...
<div class="noticesbox">
    <div class="noticewarp">
        <div class="noticetit tearch-nav tearch-navts">
            <h1>收藏夹</h1>
            <div><a href="/study_stu_question/collect">返回</a></div>
        </div>            
        <div class="noticenwarp">
            <div class="noticekatebox" style="width:730px">
                <div class="dataediabox">
                    ...
                    <div class="dataadd"><a href="javascript:collect();" title="取消收藏">取消收藏</a></div>
                    <div class="dataadd"><a title="我要提问" href="/study_stu_question/my_tiwen">我要提问</a></div>
                </div>

                <div class="serchbox">
                    <form action="/study_stu_question/collect" method="get">
