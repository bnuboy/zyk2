...
<script>
   ...
   $(document).ready(function(){
    ...
    function get_shuju()
    {
        ...
        $('#tijiao').attr('href','/study_stu_question/my_tiwen?title='+title+'&plan_id='+plan_id+'&content='+content);
    }
</script>
                ...
                <div class="noticetit tearch-nav">
                  <h2>在线答疑 > 我的问题 &gt; 提问&nbsp;</h2>                  
                    ...
                    <div class="noticenwarp" style="height:560px;">
                        ...
                        <form action="/study_stu_question/my_tiwen" method="post" id="dataform">
                            ...
                            <div class="noticekatebox" id="sendbut" style="margin-top:10px; width:708px;">
                                ...
                                <div class="addbutin"> <a href="javascript:;" onclick="return get_shuju();" class="iframe" id="tijiao">
                                   <input type="submit"  class="addbut" value="提问" /></a>
                                </div>
                            </div>
