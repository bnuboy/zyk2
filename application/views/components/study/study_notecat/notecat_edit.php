...
<div class="Stc w400" style="width: 500px;">
  <div class="Stc-top"><h1>新建分类</h1></div>
  <div class="Stc-bottom zcjg">
      <form action="/study_notecat/edit/<?=$info['id']?>" method="post" onSubmit="return check();">
  <table width="100%">
  <tr>
    <td>名称：</td>
    <td><label>
  ...
  <tr>
    ...
    <td width="25"><label>
      <textarea name="description" id="textarea" cols="35" rows="5"><?=$info['description']?></textarea>
    </label></td>
  </tr>
</table>
       <br />
 ...
 <p align="right"><input type="reset" class="remove"  value="取消" onclick="return close_win();"/> 
    <input type="submit" class="save" value="修改" /></p> 
    </form>
  </div>
</div>
</body>
