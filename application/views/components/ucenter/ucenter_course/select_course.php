...
<body>
<div class="Stc w400" style="width: 499px;height:205px;">
  <div class="Stc-top"><h1>课程选择</h1></div>
  <div class="Stc-bottom zcjg">
      <form action="/ucenter_course/add/<?=$id?>" method="post" onSubmit="return check();">
  <table width="100%">
  <tr>
    <td width="20%">名称：</td>
    <td width="80%"><label>
 ...
 <p align="right">
    <input type="submit" class="save" value="确认" /><input type="reset" class="remove"  value="取消" onclick="return close_win();"/> </p> 
    </form>
  </div>
</div>
</body>
