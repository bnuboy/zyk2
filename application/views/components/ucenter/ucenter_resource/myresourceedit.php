...
<div class="noticewarp">
  ...
  <div class="noticetit">
    <h1><img src="/resource/images/resour.gif" />我上传的资源-<?php echo !empty($data['id'])?"编辑":"新增"; ?></h1>
  </div>

  <div class="noticenwarp" style="height:830px;">

    
    
  <form action="/ucenter_resource/myresourceedit/" method="post" id="sub_form" >
    ...
    <div class="resourkate">
      ...
      <div class="resourkate">
        ...
        <div id="addfile" class="zyfl" style="line-height:30px;">
    ...
    <div class="resourkate">
      ...
      <div class="noticekatebox" style="width:800px;height:58px;">
        ...
        <div  class="addfile"  style="width:600px;height:58px;">
          ...
          <iframe style="border:0px;margin-top: -9px;" src="/Uploadfiles/uploadfileform?fileid=img&defaultvalue=<?php echo empty($data['img']) ? '' : $data['img']?>&allowed_extensions=gif|jpg|sql&overwrite=false&encrypt_name=false" scrolling="no" width="490px" height="40px;"></iframe>
        </div>
      </div>
...
<!--      <div class="noticekatebox" style="width:800px;height:58px;">
        ...
        <div  class="addfile" style="width:600px;height:58px;">
          ...
          <iframe style="border:0px;margin-top: -9px;" src="/Uploadfiles/uploadfileform?fileid=file_path_input&defaultvalue=<?php echo empty($data['file_path']) ? '' : $data['file_path']?>&fileinfoid=filepathinfo&allowed_extensions=flv|swf|gif|7z|zip|rar|jpg|png|xls|xlsx|doc|docx|pdf|ppt|pptx|mp3|mp4|avi|rm|rmvb|mov|mp4|m4a|3gp|wma&overwrite=false&encrypt_name=true&chagetoswf=true&chagetoflv=true"  scrolling="no" width="450px" height="40px;"></iframe>
        </div>
      </div>      -->

     <div class="noticekatebox" style="width:800px;height:208px;">
        <div class="addpwordn">源文件：</div>
        <div  class="addfile" style="width:600px;height:58px;">
          <input name="data[file_path]" id="file_path_input" type="hidden" value="<?=isset($data['file_path']) ? $data['file_path'] : '' ;  ?>"/>
          <input name="filepathinfo" id="filepathinfo" type="hidden" value=""/>
          <iframe style="border:0px;margin-top: -9px;" src="/swfupload/uploadform?fileid=file_path_input&fileinfo=filepathinfo"  scrolling="no" width="450px" height="200px;"></iframe>
        </div>
      </div>      
    ...
    <div class="resourkate" id="sendbut" style="margin-top:10px; width:705px;">
      <div class="addbutdel"><input type="button" onclick="location.href='/ucenter_resource/myresourcelist'" class="addbut" value="取消" /></div>
