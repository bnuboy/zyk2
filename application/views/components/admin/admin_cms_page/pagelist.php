...
<div class="noticewarp">
  ...
  <div class="noticenwarp">
     ...
     <div class="noticekatebox1">
	      <form action="/admin_cms_page/pagelist"  method="get">
	
	        <div class="notiness">共有单页<span><?= $count ?></span>条</div>
    ...
    <div class="noticekatebox">
      <div class="dataediabox">
        ...
        <div class="manageadd"><a href="/admin_cms_page/pageedit" title="新增单页">新增单页</a></div>
      </div>
    ...
    <div class="databox">
      <form id="sub_form" name="sub_form" method="post" action="/admin_cms_page/pagedel">
        ...
        <tbody id="resousdata">
          <?php foreach ( $list as $v ) { ?>
            <tr>
              ...
              <td><?= $v['order']; ?></td>
              <td>
                <a href="/admin_cms_page/pageedit?id=<?= $v['id']; ?>" title="编辑">编辑<img align="middle" src="/resource/images/ediapen.gif" width="20" height="20" /></a>&nbsp;|&nbsp;
                <a href="/admin_cms_page/pagedel?id=<?=$v['id'];?>" title="删除" onclick="javascript:return confirm('您确定要删除此单页库吗?');">删除<img align="middle" src="/resource/images/del.gif" width="16" height="17" /></a>
              </td>
            </tr>
          <?php } ?>
        </tbody>
