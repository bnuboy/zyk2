...
<div class="noticewarp">
  ...
  <div class="noticenwarp">
     ...
     <div class="noticekatebox1">
	      <form action="/admin_cms_menu/menulist"  method="get">
	
	        <div class="notiness">共有菜单<span><?= $count ?></span>条</div>
        <div class="notiness" style="margin-right:-3px;<?=$this->type=='organization'?"display:none;":""?>" >
          <select name="school_org_id" style="padding:6px;" onchange="jascript:this.form.submit();">
	        ...
	        <div class="serchbox1" style="width: 163px;">
    ...
    <div class="noticekatebox">
      <div class="dataediabox">
        ...
        <div class="manageadd"><a href="/admin_cms_menu/menuedit" title="新增菜单">新增菜单</a></div>
      </div>
    ...
    <div class="databox">
      <form id="sub_form" name="sub_form" method="post" action="/admin_cms_menu/menudel">
      <table width="100%" cellpadding="0" cellspacing="0">
        <thead>
          <tr>
            <th style="width:5%;">&nbsp;</th>
            <th style="width:30%;">名称</th>
            <th style="width:30%;">所属院系</th>
        ...
        <tbody id="resousdata">
          <?php foreach ( $list as $v ) { ?>
            <tr>
              ...
              <td><?= $v['order']; ?></td>
              <td>
                <a href="/admin_cms_menu/menuedit?id=<?= $v['id']; ?>" title="编辑">编辑<img align="middle" src="/resource/images/ediapen.gif" width="20" height="20" /></a>&nbsp;|&nbsp;
                <a href="/admin_cms_menu/menudel?id=<?=$v['id'];?>" title="删除" onclick="javascript:return confirm('您确定要删除此菜单库吗?');">删除<img align="middle" src="/resource/images/del.gif" width="16" height="17" /></a>
              </td>
            </tr>
          <?php } ?>
        </tbody>
