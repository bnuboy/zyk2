...
<form action="/admin_front_power/menuedit/<?=$data['id'];?>" enctype="multipart/form-data" method="post" id="sub_form">
  <div class="noticewarp">
    ...
    <div class="noticenwarp">
      ...
      <div class="noticekatebox" style="width:800px;height:58px;">
        <div class="maddpword">ICO：</div>
        <div  class="maddness"  style="width:600px;height:58px;">
          <input name="ico" id="ico" type="hidden" value="<?=isset($data['ico']) ? $data['ico'] : ''; ?>"/>
          <iframe style="border:0px;" src="/Uploadfiles/uploadfileform?fileid=ico&defaultvalue=<?php echo empty($data['ico']) ? '' : $data['ico']?>&allowed_extensions=gif|jpg|png&overwrite=false&encrypt_name=true&uppath=/upload/menuico/" width="400px" height="54px;"></iframe>
        </div>
      </div>
      <div class="noticekatebox" style="padding-top:5px;">
