    ...
    <div class="databox">
      ...
      <table  id="list-table" width="100%" border=0 align=center cellpadding="5" cellspacing=1 class="tbtitle tbhover">
        ...
        <tr id="<?php echo $value['level'];?>_<?php echo $value['id'];?>" class="<?php echo $value['level'];?>" <?php if($value['level']!=1) echo "style='display:none;'"?>>
          ...
          <td>
            <img src='/resource/images/ediapen.gif'><a href="/admin_front_power/menuadd/<?php echo $value['id'];?>">新增下级</a>&nbsp;
            <img src='/resource/images/ediapen.gif'><a href="/admin_front_power/menuedit/<?php echo $value['id'];?>">编辑</a>&nbsp;
            <img src='/resource/images/del.gif'><a href="/admin_front_power/menudel/<?php echo $value['id'];?>" onclick="javascript:return confirm('您确定要删除此菜单吗?');">删除</a>
          </td>
        </tr>
        <?php } ?>
      </table>
